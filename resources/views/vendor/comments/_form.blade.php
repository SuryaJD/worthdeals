    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif" name="pros" rows="2"></textarea>
            </div>

            <div class="form-group">
                <label for="cons">Cons :</label>
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif" name="cons" rows="2"></textarea>
            </div>
