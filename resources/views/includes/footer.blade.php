                ...
                <div class="col-xl-4 col-lg-4 col-sm-6">
                    <div class="widget widget-links widget-light pb-2 mb-4">
                        ...
                        <ul class="widget-list">
                            ...
                            <li class="widget-list-item"><a class="widget-list-link" href="#">Careers at Cartzilla</a>
                            </li>
                ...
                <div class="col-xl-4 col-sm-8">
                    <div class="widget pb-2 mb-4">
                        ...
                        <form class="validate"
                            ...
                            </div><small class="form-text text-light opacity-50" id="mc-helper">*Subscribe to our
                                newsletter to receive early discount offers, updates and new products info.</small>
    ...
    <div class="bg-darker px-lg-3 py-3">
        <div class="d-sm-flex justify-content-between align-items-center mx-auto px-3" style="max-width: 80rem;">
            <div class="font-size-xs text-light opacity-50 text-center text-sm-left py-3">© All rights reserved. Made by
                <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">Worthcoding Studio in India</a>
            </div>
            <div class="font-size-xs text-light opacity-50 text-center text-sm-left py-3">
                <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">Privacy Policy /</a>
                <a class="text-light" href="https://createx.studio/" target="_blank" rel="noopener">Terms and conditions /</a>
            </div>
        </div>
    </div>
</footer>